// PresupuestoPC/components/Header.tsx

import React from 'react';
import { Paper, Group, Text, Badge } from '@mantine/core';
import { IconCalculator, IconBox } from '@tabler/icons-react';

export function PresupuestoPCHeader() {
  return (
    <Paper 
      p="sm" 
      radius="lg" 
    ...
    >
      <Group justify="space-between" align="center">
        <Group gap="xs">
          <IconCalculator size={20} style={{ opacity: 0.8 }} />
          <Text fw={700} size="lg" c="white">
            Produce Cooling — Presupuesto
          </Text>
        ...
        <Group gap="xs">
          <Badge variant="outline" color="gray.2" radius="sm" style={{ color: '#FFFFFF', borderColor: '#ffffff50' }}>
            <Group gap={4}>
              <IconBox size={12} />
              Hielo híbrido 50/50 + servicio a máquinas — la vara real
            </Group>
          </Badge>
        </Group>
      </Group>
