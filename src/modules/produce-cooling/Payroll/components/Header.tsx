// Payroll/components/Header.tsx

import React from 'react';
import { Paper, Group, Text, Badge } from '@mantine/core';
import { IconUsers, IconBox } from '@tabler/icons-react';
  ...
  return (
    ...
    >
      <Group justify="space-between" align="center">
        <Group gap="xs">
          <IconUsers size={20} style={{ opacity: 0.8 }} />
          <Text fw={700} size="lg" c="white">
            Produce Cooling — Personal · Nómina y Destajo
          </Text>
        ...
        <Group gap="xs">
          <Badge variant="outline" color="gray.2" radius="sm" style={{ color: '#FFFFFF', borderColor: '#ffffff50' }}>
            <Group gap={4}>
              <IconBox size={12} />
              Plantilla, asistencia, boleta de repack — como el grower
            </Group>
          </Badge>
        </Group>
      </Group>
