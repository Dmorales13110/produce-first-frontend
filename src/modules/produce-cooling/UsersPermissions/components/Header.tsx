// UsersPermissions/components/Header.tsx

import React from 'react';
import { Paper, Group, Text, Badge } from '@mantine/core';
import { IconShieldLock, IconBox } from '@tabler/icons-react';

export function UsersPermissionsHeader() {
  return (
    <Paper 
      p="sm" 
      radius="lg" 
    ...
    >
      <Group justify="space-between" align="center">
        <Group gap="xs">
          <IconShieldLock size={20} style={{ opacity: 0.8 }} />
          <Text fw={700} size="lg" c="white">
            Produce Cooling — Usuarios y Permisos
          </Text>
        ...
        <Group gap="xs">
          <Badge variant="outline" color="gray.2" radius="sm" style={{ color: '#FFFFFF', borderColor: '#ffffff50' }}>
            <Group gap={4}>
              <IconBox size={12} />
              Cada bitácora con nombre y turno
            </Group>
          </Badge>
        </Group>
      </Group>
